...
{
    /// <summary>
    /// Describes an authorization service. Implementations of this service are required to handle GitHub's OAuth App authorization through web application flow.
    /// </summary>
    public interface IAuthorizationService 
    {
        ...
        /// </summary>
        /// <param name="state">The state returned by GitHub. You should always make sure this state matches the one provided in a call to <see cref="AuthorizeAsync"/>.</param>
